...
import { playerMaxSpeed, playerMinSpeed, isDroiteIntesection, } from "./outilsMath.js";
const collision = (Player1, Player2) => {
    // Collision avec un player static
    if (Player1.speed === 0 || Player2.speed === 0) {
        // 1 cas choc frontal
        if (Math.abs(Player1.Position.x - Player2.Position.x) <=
